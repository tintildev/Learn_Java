...
public class Server implements Runnable{
    ...
    public int wordCount (String massage){
        int count = new StringTokenizer(massage).countTokens();
        return count;
    ...
    public void run() {
        try {
            ...
            out.println("Nachricht vom Server: es wurden " + wordCount(message) + " gezählt.");
